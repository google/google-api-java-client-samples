 ...
 * @author Google, Inc.
 */
public final class Notes extends GenericJson {
   ...
   */
  public Notes setItems(java.util.List<Note> items) {
    this.items = items;
    return this;
  }
   ...
   * example, a request that returns a single {@link Notes} would include the response headers,
   * while a request which returns an array of {@link Notes}, would have a non-null response header
