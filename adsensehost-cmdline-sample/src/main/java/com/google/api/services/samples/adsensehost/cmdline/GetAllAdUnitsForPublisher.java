 ...
 *
 */
public class GetAllAdUnitsForPublisher {
   ...
   * @throws Exception
   */
  public static AdUnits run(AdSenseHost service, String accountId, String adClientId,
    ...
    do {
      adUnits = service.accounts().adunits().list(accountId, adClientId)
