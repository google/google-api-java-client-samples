...
/**
 * Sample which leases task from TaskQueueService, performs work on the paylaod
 * of the task and then  deletes the task.
 * @author Vibhooti Verma
 */
public class TaskQueuePuller {
   ...
   * queue followed by leasing tasks and deleting them. Users cna change the
  ...
  private static void getTaskQueue() throws IOException {
    ...
    queue.get(projectName, taskQueueName, true);
  }
