...
/**
 * This example creates a simple report for the given advertiser.
 *
 * Tags: reports.insert
 *
...
public class CreateReport {
  ...
  /**
   * Inserts (creates) a simple report for a given advertiser.
   *
  ...
  public static Report insert(Dfareporting reporting, Long userProfileId,
      DimensionValue advertiser, String startDate, String endDate) throws Exception {
    System.out.println("=================================================================");
    System.out.printf("Creating a new report for advertiser %s%n", advertiser.getValue());
    System.out.println("=================================================================");
    ...
    criteria.setDateRange(
        new Report.Criteria.DateRange().setStartDate(startDate).setEndDate(endDate));
    criteria.setDimensions(ImmutableList.of(new SortedDimension().setName("dfa:advertiser")));
    criteria.setMetricNames(ImmutableList.of("dfa:clicks", "dfa:impressions"));
    ...
    System.out.printf("Created report with ID \"%s\" and display name \"%s\"%n",
