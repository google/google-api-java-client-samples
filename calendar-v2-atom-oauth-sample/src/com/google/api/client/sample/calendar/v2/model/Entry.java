...
public class Entry implements Cloneable {
  ...
  Entry executeInsert(CalendarUrl url) throws IOException {
  ...
  Entry executePatchRelativeToOriginal(Entry original) throws IOException {
    HttpRequest request = Util.TRANSPORT.buildPatchRequest();
    request.setUrl(getEditLink());
