...
public class GenerateReport {
   ...
   * @throws Exception
   */
  public static void run(AdExchangeSeller adExchangeSeller, String adClientId) throws Exception {
    System.out.println("=================================================================");
    ...
    Generate request = adExchangeSeller.reports().generate(startDate, endDate);
